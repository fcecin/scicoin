...
/** Subsidy, demurrage, and budgetary requirements for Scicoin host currency */
...
static const int EQ_HEIGHT = 0;
static const mpq TITHE_RATIO = mpq("0");
static const mpq TITHE_AMOUNT = mpq("0");
static const mpq INITIAL_SUBSIDY = mpq("0");
...
// Scicoin: give the pubkey directly (which will be the wallet's default key)
...
// Scicoin: reservekey no longer needed, we pay to the wallet's defaultkey always
