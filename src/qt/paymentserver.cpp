...
const QString BITCOIN_IPC_PREFIX("scicoin:");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start scicoin: click-to-pay handler");
    else
...
{
    // clicking on scicoin: URLs creates FileOpen events on the Mac:
