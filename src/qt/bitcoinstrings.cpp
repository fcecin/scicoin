...
"for example: alertnotify=echo %%s | mail -s \"Scicoin Alert\" admin@foo."
"com\n"),
QT_TRANSLATE_NOOP("bitcoin-core", ""
...
QT_TRANSLATE_NOOP("bitcoin-core", "Listen for connections on <port> (default: 9196 or testnet: 19196)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the Scicoin Wiki for SSL setup instructions)"),
