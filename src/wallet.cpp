...
/*
  ...
  // Scicoin: default receiving address does not get replaced just because it was used
  //          the default receiving address is used by the default miner to get rewards
  //          for all blocks it finds due to scicoin's reward-more-if-lots-of-last-N-blocks-
  //          give-coinbase-mining-rewards-to-the-same-address
