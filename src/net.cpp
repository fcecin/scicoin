...
static const char *strMainNetDNSSeed[][2] = {
    ...
    {"mainnet.scicoin.pw", "seed.mainnet.scicoin.pw"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"testnet.scicoin.pw", "seed.testnet.scicoin.pw"},
    {NULL, NULL}
};
...
unsigned int pnSeed[] = { 0xAC7C3AC6 };

// FIXME no seed to test solomine to same addr
//unsigned int pnSeed[] = { };
